 ...
 * @author conta
 */
public class BancoResultsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String bresultslocado = request.getParameter("bresultslocado");
        String bresultstitulo = request.getParameter("bresultstitulo");
