...
public class FuncionarioCadastroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fcadastronome = request.getParameter("fcadastronome");
        String fcadastrocpf = request.getParameter("fcadastrocpf");
...
<<<<<<< HEAD
        ...
        Funcionario f = new Funcionario(fcadastronome, fcadastrocpf, fcadastronascimento, fcadastrogerente, fcadastropass, fcadastroddd, fcadastrotel);
